...
namespace engine::config::eval
{
    ...
    static constexpr int mg_pawn_table[core::constants::BoardSize] = {
        0, 0, 0, 0, 0, 0, 0, 0,
        5, 5, 5, 5, 5, 5, 5, 5,
        6, 6, 8, 10, 10, 8, 6, 6,
        8, 8, 12, 14, 14, 12, 8, 8,
    ...
    static constexpr int mg_knight_table[core::constants::BoardSize] = {
        ...
        -20, -5, 0, 5, 5, 0, -5, -20,
        -30, -20, -10, -10, -10, -10, -20, -30};
    static constexpr int mg_bishop_table[core::constants::BoardSize] = {
    ...
    static constexpr int mg_rook_table[core::constants::BoardSize] = {
        0, 0, 0, 5, 5, 0, 0, 0,
    ...
    static constexpr int mg_queen_table[core::constants::BoardSize] = {
    ...
    static constexpr int mg_king_table[core::constants::BoardSize] = {
        ...
        -20, -30, -40, -50, -50, -40, -30, -20,
        -20, -30, -40, -50, -50, -40, -30, -20};
    static constexpr int eg_king_table[core::constants::BoardSize] = {
        -10, -5, 0, -5, -5, 0, -5, -10,
        -5, -5, 0, 5, 7, 5, -5, -5,
        -5, -5, 5, 10, 10, 5, -5, -5,
        -5, 0, 10, 15, 15, 10, 0, -5,
    ...
    static constexpr int eg_pawn_table[core::constants::BoardSize] = {
        0, 0, 0, 0, 0, 0, 0, 0,
        5, 6, 7, 8, 8, 7, 6, 5,
    ...
    static constexpr int eg_knight_table[core::constants::BoardSize] = {
        -30, -20, -10, -10, -10, -10, -20, -30,
        -20, -5, 0, 5, 5, 0, -5, -20,
        -10, 5, 10, 15, 15, 10, 5, -10,
        -10, 5, 15, 20, 20, 15, 5, -10,
        ...
        -20, -5, 0, 5, 5, 0, -5, -20,
        -30, -20, -10, -10, -10, -10, -20, -30};
    static constexpr int eg_bishop_table[core::constants::BoardSize] = {
        -15, -10, -10, -10, -10, -10, -10, -15,
        -10, 0, 0, 5, 5, 0, 0, -10,
        -10, 5, 10, 10, 10, 10, 5, -10,
        -10, 5, 10, 15, 15, 10, 5, -10,
    ...
    static constexpr int eg_rook_table[core::constants::BoardSize] = {
        0, 0, 0, 5, 5, 0, 0, 0,
        5, 10, 15, 15, 15, 15, 10, 5, // 2e rangée
        -5, 0, 0, 0, 0, 0, 0, -5,
        -5, 0, 0, 0, 0, 0, 0, -5,
        ...
        5, 10, 15, 15, 15, 15, 10, 5, // 7e rangée (après miroir)
        0, 0, 0, 5, 5, 0, 0, 0};
    static constexpr int eg_queen_table[core::constants::BoardSize] = {
        -20, -10, -10, -5, -5, -10, -10, -20,
        -10, 0, 5, 5, 5, 5, 0, -10,
        -10, 5, 10, 10, 10, 10, 5, -10,
        -5, 5, 10, 15, 15, 10, 5, -5,
    ...
    static constexpr std::array<int, core::constants::PieceTypeCount> pieces_score = {
