...
// against data/nnue/v2.nnue's header hash (see nnue_eval_v2.hpp for the
// verification note).
//
...
public:
    ...
    NnueModelV2(AccBiases &&acc_biases, AccWeights &&acc_weights, PsqtWeights &&psqt_weights, LayerStacksArr &&layer_stacks_)
